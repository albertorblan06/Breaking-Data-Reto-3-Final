...
for rhythm in [3, 4, 7]:
    ...
    agente.configurar()
    agente.ruta_modelo_onnx = os.path.join(os.path.dirname(script), "exact_heuristic.onnx")
    ...
    for match in range(matches):
        ...
        score_diff += score
    print(f"Rhythm {rhythm} Wins: {wins}/{matches}, Ties: {ties}, Avg Score: {score_diff/matches}")
